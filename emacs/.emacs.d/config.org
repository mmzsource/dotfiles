...
(setq org-capture-templates
  '(("b" "Blog idea"
     entry
     (file+headline "~/Dropbox/org/capture.org" "Blog")
     "* %?\n")

    ("e" "Essay idea"
    entry
    (file+headline "~/Dropbox/org/capture.org" "Essay")
    "* %?\n")

    ("i" "Idea"
    entry
    (file+headline "~/Dropbox/org/capture.org" "Idea")
    "* %?\n")

    ("r" "Read"
    entry
    (file+headline "~/Dropbox/org/capture.org" "Read")
    "* %?\n")

    ("t" "Todo"
    entry
    (file+headline "~/Dropbox/org/capture.org" "TODO")
    "* TODO %?\n")))
#+END_SRC
