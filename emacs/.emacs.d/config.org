...
So after applying another team, I can now always return to my default theme by
...
;; Don't ask me which buffer to kill, just kill
...
Most of the times it's also convenient that emacs opens previously opened files
...
** TODO Define org folder (for summarizing todo's in org-mode)
