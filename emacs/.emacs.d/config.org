...
The emacs-lisp code in this file will run when emacs starts. A great use case for [[https://en.wikipedia.org/wiki/Literate_programming]['literate programming']] imho.
...
Build a list of recently used files, easily accessible via a keybinding.
